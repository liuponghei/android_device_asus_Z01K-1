...
PLATFORM_PATH := device/asus/Z01K
...
# Init
TARGET_INIT_VENDOR_LIB := libinit_Z01K
TARGET_RECOVERY_DEVICE_MODULES := libinit_Z01K
...
# Shims
TARGET_LD_SHIM_LIBS := \
    /vendor/lib/hw/camera.sdm660.so|libcamera_shim.so
